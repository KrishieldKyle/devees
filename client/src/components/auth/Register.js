                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <p className="lead text-center">Create your Devees account</p>
                            <form noValidate onSubmit={this.onSubmit}>
                                <div className="form-group">
                                    <input type="text" className={classnames('form-control form-control-lg', { 'is-invalid': errors.name })} placeholder="Name" value={this.state.name} name="name" onChange={this.onChange} />
